...
public class DimSumOrdering
{
    ...
    public void start() {
        ...
        do {
            ...
            switch (choice) {
                case "1":
                dishes[0].DimSumQuantity++;
                break;
                case "2":
                dishes[1].DimSumQuantity++;
                break;
                case "3":
                dishes[2].DimSumQuantity++;
                break;
                case "4":
                dishes[3].DimSumQuantity++;
                break;
            }
            System.out.println();
    ...
    public void showBill() {
        ...
        for (int i = 0; i < dishes.length; i++) {
            System.out.println(dishes[i].getQuantity()+"\t$"+dishes[i].getPrice()*dishes[i].getQuantity()+"\t"+dishes[i].getName());
        }
        System.out.println("----------------------------------");
        ...
        for (int j = 0; j < dishes.length; j++){
            total+=dishes[j].getPrice()*dishes[j].getQuantity();
        }
